                            ...
                            <Swiper {...swiperOptions} className="swiper-wrapper pb-70 pt-5">
                                <SwiperSlide>
                                    <div className="card-testimonial-2">
                                        <div className="card-image"><img src="/assets/imgs/page/homepage6/review1.png" alt="Nivia" /></div>
                                        <div className="card-info">
                                            <div className="card-logo"><img src="/assets/imgs/page/homepage6/minty.png" alt="Nivia" /></div>
                                            ...
                                            <div className="card-author">
                                                ...
                                                <div className="card-rates"><img src="/assets/imgs/page/homepage6/star-sm.svg" alt="Nivia" /><img src="/assets/imgs/page/homepage6/star-sm.svg" alt="Nivia" /><img src="/assets/imgs/page/homepage6/star-sm.svg" alt="Nivia" /><img src="/assets/imgs/page/homepage6/star-sm.svg" alt="Nivia" /><img src="/assets/imgs/page/homepage6/star-sm.svg" alt="Nivia" /></div>
                                            </div>
                                        </div>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide>
                                    <div className="card-testimonial-2">
                                        <div className="card-image"><img src="/assets/imgs/page/homepage6/review2.png" alt="Nivia" /></div>
                                        <div className="card-info">
                                            <div className="card-logo"><img src="/assets/imgs/page/homepage6/minty.png" alt="Nivia" /></div>
                                            <div className="card-comment">
                                                <p className="text-md neutral-700">“Discover what sets this apart as the
